...
(0, _jquery2.default)(document).ready(function () {
  ...
  consoleType(); // Call functions on scroll
...
var colorNav = function colorNav() {
  var pos = (0, _jquery2.default)(window).scrollTop();
  var pj1Pos = (0, _jquery2.default)('.pj1').position();

  if (pos >= pj1Pos.top - 56) {
    (0, _jquery2.default)('.navbar').css('backgroundColor', 'rgba(0,0,0,0.2');
    (0, _jquery2.default)('.name-rmdr').hide(300);
  } else {
    (0, _jquery2.default)('.navbar').css('backgroundColor', 'transparent');
    (0, _jquery2.default)('.name-rmdr').show(300);
  }
};
/* Parallax Views */
...
var parallaxViews = function parallaxViews() {
  new _rellax2.default('.pj1 .parallax-img', {
    speed: 4,
    center: true
  });
  new _rellax2.default('.pj2 .parallax-img:first-child', {
    speed: 7,
    center: true
  });
  new _rellax2.default('.pj2 .parallax-img:nth-child(2)', {
    speed: 2,
    center: true
  });
};

var drawConsole = function drawConsole() {
  (0, _animejs2.default)({
    targets: '.draw',
    strokeDashoffset: [_animejs2.default.setDashoffset, 20],
    ...
    update: function update(anim) {
      var a = Math.round(anim.progress) / 100;
      console.log(a);
      (0, _jquery2.default)('.name:eq(0)').css({
        color: "rgba(76, 175, 80," + a + ")"
      });
      (0, _jquery2.default)('.typed-cursor:eq(0)').css({
        backgroundColor: "rgba(255, 255, 255," + a + ")"
      });
      (0, _jquery2.default)('.draw').css({
        fill: "rgba(0, 4, 44," + a + ")"
      });
      (0, _jquery2.default)('.st1').css({
        fill: "rgba(243, 190, 78," + a + ")"
      });
      (0, _jquery2.default)('.st2').css({
        fill: "rgba(235, 104, 93," + a + ")"
      });
      (0, _jquery2.default)('.st3').css({
...
var consoleType = function consoleType() {
  new _typed2.default('.ny', {
    ...
    onComplete: function onComplete(self) {
      (0, _jquery2.default)('.typed-cursor:eq(0)').hide();
      (0, _jquery2.default)('.name:eq(1)').show();
  ...
  new _typed2.default('.sd', {
    ...
    cursorChar: '',
    onComplete: function onComplete(self) {
      (0, _jquery2.default)('.typed-cursor:eq(1)').hide();
      (0, _jquery2.default)('.name:eq(2)').show();
  ...
  new _typed2.default('.title', {
    ...
    cursorChar: '',
    onComplete: function onComplete(self) {
      (0, _jquery2.default)('#arrow').fadeIn(500);
    }
  });
};
...
var canvas = function canvas() {
  var pos = (0, _jquery2.default)(window).scrollTop();
  var pj1Pos = (0, _jquery2.default)('.pj1').position();
  var pj2Pos = (0, _jquery2.default)('.pj2').position();
...
},{"animejs":2,"jquery":3,"rellax":4,"typed.js":5}],2:[function(require,module,exports){
/*
 * anime.js v3.0.1
